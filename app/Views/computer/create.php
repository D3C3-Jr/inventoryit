                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm mb-2">
                            ...
                            <input type="text" disabled class="form-control <?= $validation->hasError('ip_address') ? 'is-invalid' : ''; ?>" id="ipAdress" name="ip_address" placeholder="IP Address" value="<?= old('ip_address'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-sm mb-2">
                            <label for="macAdress" class="form-label">MAC Adress</label>
                            <input type="text" disabled class="form-control mac <?= $validation->hasError('mac_address') ? 'is-invalid' : ''; ?>" id="macAdress" name="mac_address" placeholder="MAC Adress" value="<?= old('mac_address'); ?>">
                            <div class="invalid-feedback">
                                <?= $validation->getError('mac_address'); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm mb-2">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('host_name') ? 'is-invalid' : ''; ?>" id="hostName" name="host_name" placeholder="Hostname" value="<?= old('host_name'); ?>">
                            <div class="invalid-feedback">
                                <?= $validation->getError('host_name'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    $(document).ready(function() {
        $('.form-check-input').click(function() {
            if ($(this).is(':checked')) {
                $('#ipAdress').attr('disabled', false);
                $('#macAdress').attr('disabled', false);
            } else {
                $('#ipAdress').attr('disabled', true);
